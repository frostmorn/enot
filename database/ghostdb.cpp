...
CCallableLiAPlayerAdd *CGHostDB :: ThreadedLiAPlayerAdd( uint32_t nGameID, uint32_t nColour, int32_t nPTS, uint32_t nDeaths, uint32_t nCreepKills, uint32_t nBossKills, std::string nItem1, std::string nItem2, std::string nItem3, std::string nItem4, std::string nItem5, std::string nItem6, std::string nHero )

{
	return NULL;
}

CCallableLiAPlayerSummaryCheck *CGHostDB :: ThreadedLiAPlayerSummaryCheck( std::string name )
{
	return NULL;
}
#endif
...
CDBDotAPlayer :: CDBDotAPlayer( ) : m_ID( 0 ), m_GameID( 0 ), m_Colour( 0 ), m_Kills( 0 ), m_Deaths( 0 ), m_CreepKills( 0 ), m_CreepDenies( 0 ),
 m_Assists( 0 ), m_Gold( 0 ), m_NeutralKills( 0 ), m_NewColour( 0 ), m_TowerKills( 0 ), m_RaxKills( 0 ), m_CourierKills( 0 )
{

}

CDBDotAPlayer :: CDBDotAPlayer( uint32_t nID, uint32_t nGameID, uint32_t nColour, uint32_t nKills, uint32_t nDeaths, uint32_t nCreepKills, 
uint32_t nCreepDenies, uint32_t nAssists, uint32_t nGold, uint32_t nNeutralKills, std::string nItem1, std::string nItem2, std::string nItem3, std::string nItem4, 
std::string nItem5, std::string nItem6, std::string nHero, uint32_t nNewColour, uint32_t nTowerKills, uint32_t nRaxKills, uint32_t nCourierKills )
    : m_ID( nID ), m_GameID( nGameID ), m_Colour( nColour ), m_Kills( nKills ), m_Deaths( nDeaths ), m_CreepKills( nCreepKills ),
	 m_CreepDenies( nCreepDenies ), m_Assists( nAssists ), m_Gold( nGold ), m_NeutralKills( nNeutralKills ), m_Hero( nHero ), m_NewColour( nNewColour ), 
	 m_TowerKills( nTowerKills ), m_RaxKills( nRaxKills ), m_CourierKills( nCourierKills )
{
	m_Items[0] = nItem1;
	m_Items[1] = nItem2;
	m_Items[2] = nItem3;
...
CDBLiAPlayer :: CDBLiAPlayer( uint32_t nID, uint32_t nGameID, uint32_t nColour, int32_t nPTS, uint32_t nDeaths, uint32_t nCreepKills, uint32_t nBossKills, std::string nItem1, std::string nItem2, std::string nItem3, std::string nItem4, std::string nItem5, std::string nItem6, std::string nHero)
    : m_ID( nID ), m_GameID( nGameID ), m_Colour( nColour ), m_Deaths( nDeaths ), m_CreepKills( nCreepKills ), m_BossKills( nBossKills ),  m_Hero( nHero )
{
	m_Items[0] = nItem1;
	m_Items[1] = nItem2;
	m_Items[2] = nItem3;
...
CDBLiAPlayerSummary:: CDBLiAPlayerSummary( std::string nServer, std::string nName, uint32_t nTotalGames, uint32_t nTotalWins,
...
std::string CDBLiAPlayer :: GetItem( unsigned int i )
{
	if( i < 6 )
		return m_Items[i];
...
void CDBLiAPlayer :: SetItem( unsigned int i, std::string item )
{
	if( i < 6 )
		m_Items[i] = item;
}
