...
typedef pair<string,CCallableLiAPlayerSummaryCheck *> PairedLPSCheck;
...
private:
	...
	vector<PairedLPSCheck> m_PairedLPSChecks;		// vector of paired threaded database LiA player summary checks in progress
