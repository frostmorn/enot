...
DFLAGS = 
OFLAGS = -O3
LFLAGS = -L. -L./bncsutil/src/bncsutil/ -L./StormLib/stormlib/ -lbncsutil -lpthread -ldl -lz -lStorm -lmysqlclient -lboost_date_time -lboost_system -lboost_filesystem -lgmp -lcurl
CFLAGS = -g3 -Wall
...
ghost.o: discord.o ghost.h includes.h util.h crc32.h sha1.h csvparser.h config.h language.h socket.h ghostdb.h ghostdbsqlite.h ghostdbmysql.h bnet.h map.h packed.h savegame.h gameplayer.h gameprotocol.h gpsprotocol.h game_base.h game.h game_admin.h
